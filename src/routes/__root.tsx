...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Pixel Pulse Rush" },
      { name: "description", content: "Neon chiptune rhythm rush — tap the beat, chase the combo." },
      { property: "og:title", content: "Pixel Pulse Rush" },
      { property: "og:description", content: "Neon chiptune rhythm rush — tap the beat, chase the combo." },
